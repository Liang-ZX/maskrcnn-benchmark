...
def boxlist_nms(boxlist_left, boxlist_right, nms_thresh, max_proposals=-1, score_field="scores"):
    """
...
#     new append
    ...
    keep = torch.from_numpy(np.intersect1d(keep_left.cpu().numpy(), keep_right.cpu().numpy())).cuda()
#     
    if max_proposals > 0:
