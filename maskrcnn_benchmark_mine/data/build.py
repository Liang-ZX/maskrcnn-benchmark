...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, is_for_period=False, left_image=True):
    ...
    if left_image == True:
        ...
        dataset_list = cfg.DATASETS.TRAIN_RIGHT if is_train else cfg.DATASETS.TEST_RIGHT
