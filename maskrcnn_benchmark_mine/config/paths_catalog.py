...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        # kitti
        ###########################################################################
        "voc_kitti_train_left_coco": {
            "img_dir": "kitti/label2/JPEGImages",
            "ann_file": "kitti/label2/Annotations/pascal_train2007.json"
        },
        "voc_kitti_val_left_coco": {
            "img_dir": "kitti/label2/JPEGImages",
            "ann_file": "kitti/label2/Annotations/pascal_val2007.json"
        },
        "voc_kitti_test_left_coco": {
            "img_dir": "kitti/label2/JPEGImages",
            "ann_file": "kitti/label2/Annotations/pascal_test2007.json"
        },
        
        "voc_kitti_train_right_coco": {
            "img_dir": "kitti/label3/JPEGImages",
            "ann_file": "kitti/label3/Annotations/pascal_train2007.json"
        },
        "voc_kitti_val_right_coco": {
            "img_dir": "kitti/label3/JPEGImages",
            "ann_file": "kitti/label3/Annotations/pascal_val2007.json"
        },
        "voc_kitti_test_right_coco": {
            "img_dir": "kitti/label3/JPEGImages",
            "ann_file": "kitti/label3/Annotations/pascal_test2007.json"
        },
        ##############################################################################
        "voc_2007_train": {
    ...
    def get(name):
        ...
        elif "voc" in name or "kitti" in name:
            data_dir = DatasetCatalog.DATA_DIR
            attrs = DatasetCatalog.DATASETS[name]
            args = dict(
